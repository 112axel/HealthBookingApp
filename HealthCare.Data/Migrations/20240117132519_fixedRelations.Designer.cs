...
namespace HealthCare.WebApp.Migrations
{
    ...
    [Migration("20240117132519_fixedRelations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCare.Domain.Models.Patient", b =>
                {
                    b.HasOne("HealthCare.Domain.Models.Account", "Account")
                        .WithOne("Patient")
                        .HasForeignKey("HealthCare.Domain.Models.Patient", "AccountId")
            ...
            modelBuilder.Entity("HealthCare.Domain.Models.Schedule", b =>
                {
                    b.HasOne("HealthCare.Domain.Models.Staff", null)
                        .WithMany("Schedule")
                        .HasForeignKey("StaffId");
                });
            ...
            modelBuilder.Entity("HealthCare.Domain.Models.Staff", b =>
                {
                    b.HasOne("HealthCare.Domain.Models.Account", "Account")
                        .WithOne("Staff")
                        .HasForeignKey("HealthCare.Domain.Models.Staff", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HealthCare.Domain.Models.Account", null)
                        .WithMany()
